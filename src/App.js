    ...
    return (
      <div style={{display:"flex",flexDirection:"column",gap:22}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:12}}>
          ...
          <div style={{display:"flex",gap:7}}><button className="btn btn-s" style={{fontSize:12.5}} onClick={()=>setQuickModal(true)}><Zap size={13}/>Rápido</button><button className="btn btn-p pulse" onClick={()=>openAdd()}><Plus size={13}/>Adicionar</button></div>
        </div>
        {/* Countdown */}
